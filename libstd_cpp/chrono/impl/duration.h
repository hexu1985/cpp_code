...
#ifndef HX_CHRONO_DURATION_H
#define HX_CHRONO_DURATION_H
...
struct common_type<Hx::chrono::duration<Rep1, Period1>, 
	Hx::chrono::duration<Rep2, Period2>> {
	typedef Hx::chrono::duration<typename common_type<Rep1, Rep2>::type,
		typename Hx::ratio_gcd<Period1, Period2>::type> type;
};
